...
@Named
@ViewScoped
public class MaquinasEstado implements Serializable {

    private boolean estado;
    private ListadoMaquinasEstadoModel arrayDeJson;
    private TokenModel token;
    private List<MaquinaEstadoModel> listadoEstablecimientos;
    private List<MaquinaEstadoModel> filterEstablecimientos;
    ...
    public void consumidor() {
        try {
            ...
            arrayDeJson = new ListadoMaquinasEstadoModel();
            arrayDeJson = (ListadoMaquinasEstadoModel) services.consumidorDerecursoPorTokenGet(parametros, "http://"+Const.rutaServ+":8080/Ws-oauth2-gs/resources/reportes/reporteMaquinaEst",
                    "Bearer " + token.getAccessToken(), arrayDeJson);
            listadoEstablecimientos = arrayDeJson.getReporteTiendaEst();
            if (token != null) {
...
public StreamedContent onImprime() throws JRException, IOException {
        ...
        InputStream jasperReport = ((ServletContext) FacesContext.getCurrentInstance().getExternalContext().getContext()).getResourceAsStream("/reports/rpt_estado_maquina.jasper");
    ...
    public ListadoMaquinasEstadoModel getArrayDeJson() {
        return arrayDeJson;
    }

    public void setArrayDeJson(ListadoMaquinasEstadoModel arrayDeJson) {
        this.arrayDeJson = arrayDeJson;
    }

    public List<MaquinaEstadoModel> getListadoEstablecimientos() {
        return listadoEstablecimientos;
    }

    public void setListadoEstablecimientos(List<MaquinaEstadoModel> listadoEstablecimientos) {
        this.listadoEstablecimientos = listadoEstablecimientos;
    }

    public List<MaquinaEstadoModel> getFilterEstablecimientos() {
        return filterEstablecimientos;
    }

    public void setFilterEstablecimientos(List<MaquinaEstadoModel> filterEstablecimientos) {
