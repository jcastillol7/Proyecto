...
@Named
@ViewScoped
public class PromDevMaq implements Serializable {

    private boolean estado;
    private ListadoPromDevMaqModel arrayDeJson;
    private TokenModel token;
    private List<PromDevMaqModel> listadoEstablecimientos;
    private List<PromDevMaqModel> filterEstablecimientos;
    ...
    public void consumidor() {
        try {
            ...
            arrayDeJson = new ListadoPromDevMaqModel();
            arrayDeJson = (ListadoPromDevMaqModel) services.consumidorDerecursoPorTokenGet(parametros, "http://"+Const.rutaServ+":8080/Ws-oauth2-gs/resources/reportes/reporteProDevMaq",
                    "Bearer " + token.getAccessToken(), arrayDeJson);
            listadoEstablecimientos = arrayDeJson.getReporteProDevMaq();
            if (token != null) {
...
public StreamedContent onImprime() throws JRException, IOException {
    ...
    public ListadoPromDevMaqModel getArrayDeJson() {
        return arrayDeJson;
    }

    public void setArrayDeJson(ListadoPromDevMaqModel arrayDeJson) {
        this.arrayDeJson = arrayDeJson;
    }

    public List<PromDevMaqModel> getListadoEstablecimientos() {
        return listadoEstablecimientos;
    }

    public void setListadoEstablecimientos(List<PromDevMaqModel> listadoEstablecimientos) {
        this.listadoEstablecimientos = listadoEstablecimientos;
    }

    public List<PromDevMaqModel> getFilterEstablecimientos() {
        return filterEstablecimientos;
    }

    public void setFilterEstablecimientos(List<PromDevMaqModel> filterEstablecimientos) {
