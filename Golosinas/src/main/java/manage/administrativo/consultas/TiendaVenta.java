...
public class TiendaVenta implements Serializable {
    ...
    private ListadoTiendaVent arrayDeJson;
    private TokenModel token;
    private List<TiendaVentModel> listadoEstablecimientos;
    private List<TiendaVentModel> filterEstablecimientos;
    ...
    public void consumidor() {
        try {
            ...
            arrayDeJson = new ListadoTiendaVent();
            arrayDeJson = (ListadoTiendaVent) services.consumidorDerecursoPorTokenGet(parametros, "http://"+Const.rutaServ+":8080/Ws-oauth2-gs/resources/reportes/reporteTiendasVent",
                    "Bearer " + token.getAccessToken(), arrayDeJson);
            listadoEstablecimientos = arrayDeJson.getReportTiendaVent();
            if (token != null) {
...
public StreamedContent onImprime() throws JRException, IOException {
    ...
    public ListadoTiendaVent getArrayDeJson() {
        return arrayDeJson;
    }

    public void setArrayDeJson(ListadoTiendaVent arrayDeJson) {
        this.arrayDeJson = arrayDeJson;
    }

    public List<TiendaVentModel> getListadoEstablecimientos() {
        return listadoEstablecimientos;
    }

    public void setListadoEstablecimientos(List<TiendaVentModel> listadoEstablecimientos) {
        this.listadoEstablecimientos = listadoEstablecimientos;
    }

    public List<TiendaVentModel> getFilterEstablecimientos() {
        return filterEstablecimientos;
    }

    public void setFilterEstablecimientos(List<TiendaVentModel> filterEstablecimientos) {
